...
$(document).ready(function(){
	{params}
	var modenum = 'custfuwu',modename='客户服务',isflow=1,modeid='122',atype = params.atype,pnum=params.pnum,modenames='',listname='Y3VzdGFwcHk:';
...
<div>
	...
	<tr>
		...
		<td><select class="form-control" style="width:120px;border-left:0;border-radius:0;" id="selstatus_{rand}"><option value="">-全部状态-</option><option style="color:blue" value="0">待处理</option><option style="color:green" value="1">已完成</option><option style="color:red" value="2">未完成</option><option style="color:#888888" value="5">已作废</option><option style="color:#17B2B7" value="23">退回</option></select></td>
		<td>
